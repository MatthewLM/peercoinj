...
import io.xpydev.paycoinj.core.PeerFilterProvider;
...
/**
 * <p>A reusable object that will calculate, given a list of {@link io.xpydev.paycoinj.core.PeerFilterProvider}s, a merged
 * {@link io.xpydev.paycoinj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link io.xpydev.paycoinj.core.PeerGroup} class internally.</p>
 *
