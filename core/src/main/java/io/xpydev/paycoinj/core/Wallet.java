...
import io.xpydev.paycoinj.wallet.AllRandomKeysRotating;
import io.xpydev.paycoinj.wallet.KeyTimeCoinSelector;
import io.xpydev.paycoinj.wallet.DecryptingKeyBag;
import io.xpydev.paycoinj.wallet.KeyBag;
import io.xpydev.paycoinj.wallet.RedeemData;
import io.xpydev.paycoinj.wallet.DeterministicSeed;
import io.xpydev.paycoinj.wallet.CoinSelection;
...
import io.xpydev.paycoinj.protocols.payments.Protos.PaymentDetails;
import io.xpydev.paycoinj.core.TransactionConfidence.ConfidenceType;
...
import io.xpydev.paycoinj.script.ScriptChunk;
import io.xpydev.paycoinj.signers.LocalTransactionSigner;
import io.xpydev.paycoinj.signers.MissingSigResolutionSigner;
...
import io.xpydev.paycoinj.utils.BaseTaggableObject;
import io.xpydev.paycoinj.utils.ExchangeRate;
import io.xpydev.paycoinj.utils.ListenerRegistration;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, io.xpydev.paycoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
     ...
     * {@link io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link io.xpydev.paycoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link io.xpydev.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, io.xpydev.paycoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link io.xpydev.paycoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link io.xpydev.paycoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link io.xpydev.paycoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws io.xpydev.paycoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(io.xpydev.paycoinj.crypto.KeyCrypter,
     ...
     * {@link io.xpydev.paycoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link io.xpydev.paycoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link io.xpydev.paycoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link io.xpydev.paycoinj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link io.xpydev.paycoinj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link io.xpydev.paycoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     */
    public void setTransactionBroadcaster(@Nullable io.xpydev.paycoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws io.xpydev.paycoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
     ...
     * {@link io.xpydev.paycoinj.core.PeerFilterProvider} interface and generally should not be used directly by apps.
