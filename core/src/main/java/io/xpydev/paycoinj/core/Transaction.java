...
import static io.xpydev.paycoinj.core.Utils.*;
...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, io.xpydev.paycoinj.script.Script, ECKey, io.xpydev.paycoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], io.xpydev.paycoinj.core.Transaction.SigHash, boolean)}
