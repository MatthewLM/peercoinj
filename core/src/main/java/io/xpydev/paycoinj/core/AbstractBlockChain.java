 ...
 * the lightweight SPV mode, a {@link io.xpydev.paycoinj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link io.xpydev.paycoinj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
