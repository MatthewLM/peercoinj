...
public abstract class NetworkParameters implements Serializable {
    ...
    /**
     * First byte of a base58 encoded address. See {@link io.xpydev.paycoinj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link io.xpydev.paycoinj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link io.xpydev.paycoinj.core.AlertMessage}s. You can use {@link io.xpydev.paycoinj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
