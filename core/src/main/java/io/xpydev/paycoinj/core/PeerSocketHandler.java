...
import io.xpydev.paycoinj.net.MessageWriteTarget;
import io.xpydev.paycoinj.net.StreamParser;
 ...
 * {@link io.xpydev.paycoinj.net} classes and {@link Peer}.
 */
public abstract class PeerSocketHandler extends AbstractTimeoutHandler implements StreamParser {
     ...
     * called automatically by {@link io.xpydev.paycoinj.net.NioClient} or
     * {@link io.xpydev.paycoinj.net.NioClientManager} once the socket finishes initialization.
     */
    @Override
