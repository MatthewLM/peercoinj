...
import io.xpydev.paycoinj.crypto.NativeSecp256k1;
...
public class ECKey implements EncryptableItem, Serializable {
     ...
     * usually encoded using DER format, so you want {@link io.xpydev.paycoinj.core.ECKey.ECDSASignature#toASN1()}
    ...
    /**
     * Signs the given hash and returns the R and S components as BigIntegers. In the Paycoin protocol, they are
     * usually encoded using DER format, so you want {@link io.xpydev.paycoinj.core.ECKey.ECDSASignature#encodeToDER()}
     ...
     * the {@link io.xpydev.paycoinj.core.DumpedPrivateKey#toString()} method to get the string.
     *
