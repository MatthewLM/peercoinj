...
import io.xpydev.paycoinj.net.AbstractTimeoutHandler;
 ...
 * {@link io.xpydev.paycoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link io.xpydev.paycoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link io.xpydev.paycoinj.net.NioClientManager#openConnection(java.net.SocketAddress, io.xpydev.paycoinj.net.StreamParser)}
     * or
     * {@link io.xpydev.paycoinj.net.NioClient#NioClient(java.net.SocketAddress, io.xpydev.paycoinj.net.StreamParser, int)}.</p>
     *
     ...
     * Once the pong is received the value returned by {@link io.xpydev.paycoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link io.xpydev.paycoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link io.xpydev.paycoinj.core.Peer#ping()} has never
