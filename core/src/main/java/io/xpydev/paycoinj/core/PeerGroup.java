...
import io.xpydev.paycoinj.crypto.DRMWorkaround;
import io.xpydev.paycoinj.net.BlockingClientManager;
import io.xpydev.paycoinj.net.ClientConnectionManager;
import io.xpydev.paycoinj.net.FilterMerger;
import io.xpydev.paycoinj.net.NioClientManager;
import io.xpydev.paycoinj.net.discovery.PeerDiscovery;
import io.xpydev.paycoinj.net.discovery.PeerDiscoveryException;
import io.xpydev.paycoinj.net.discovery.TorDiscovery;
import io.xpydev.paycoinj.script.Script;
import io.xpydev.paycoinj.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     * peers. By using this with {@link io.xpydev.paycoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link io.xpydev.paycoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link io.xpydev.paycoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link io.xpydev.paycoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link io.xpydev.paycoinj.core.Peer#ping()}.
     */
