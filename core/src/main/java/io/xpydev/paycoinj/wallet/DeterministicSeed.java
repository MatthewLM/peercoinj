...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link io.xpydev.paycoinj.crypto.MnemonicCode} for more
     ...
     *
     * @throws io.xpydev.paycoinj.crypto.MnemonicException if check fails
     */
