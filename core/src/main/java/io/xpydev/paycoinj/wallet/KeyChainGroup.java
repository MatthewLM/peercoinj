...
/**
 * <p>A KeyChainGroup is used by the {@link io.xpydev.paycoinj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws io.xpydev.paycoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link io.xpydev.paycoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws io.xpydev.paycoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
