...
import io.xpydev.paycoinj.crypto.EncryptableItem;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws io.xpydev.paycoinj.store.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws io.xpydev.paycoinj.store.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(io.xpydev.paycoinj.crypto.KeyCrypter,
