...
import io.xpydev.paycoinj.crypto.EncryptedData;
...
import io.xpydev.paycoinj.crypto.DeterministicHierarchy;
import io.xpydev.paycoinj.crypto.HDKeyDerivation;
import io.xpydev.paycoinj.crypto.HDUtils;
import io.xpydev.paycoinj.crypto.KeyCrypterException;
import io.xpydev.paycoinj.crypto.MnemonicCode;
import io.xpydev.paycoinj.core.BloomFilter;
 ...
 * {@link io.xpydev.paycoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link io.xpydev.paycoinj.crypto.MnemonicCode},
 ...
 * {@link io.xpydev.paycoinj.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link io.xpydev.paycoinj.crypto.DeterministicKey#deserializeB58(io.xpydev.paycoinj.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(io.xpydev.paycoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link io.xpydev.paycoinj.crypto.DeterministicHierarchy} and
 * {@link io.xpydev.paycoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(io.xpydev.paycoinj.crypto.DeterministicKey)}
