...
import io.xpydev.paycoinj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /**
     * Parse a human readable coin value to a {@link io.xpydev.paycoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link io.xpydev.paycoinj.core.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
