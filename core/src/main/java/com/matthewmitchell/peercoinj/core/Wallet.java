...
import com.matthewmitchell.peercoinj.protocols.payments.Protos.PaymentDetails;
...
import com.matthewmitchell.peercoinj.signers.LocalTransactionSigner;
import com.matthewmitchell.peercoinj.signers.MissingSigResolutionSigner;
...
import com.matthewmitchell.peercoinj.utils.BaseTaggableObject;
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
     ...
     * {@link com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.matthewmitchell.peercoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.matthewmitchell.peercoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /** See {@link com.matthewmitchell.peercoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.matthewmitchell.peercoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link com.matthewmitchell.peercoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws com.matthewmitchell.peercoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link com.matthewmitchell.peercoinj.signers.TransactionSigner.MissingSignatureException}
     ...
     * @throws com.matthewmitchell.peercoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
