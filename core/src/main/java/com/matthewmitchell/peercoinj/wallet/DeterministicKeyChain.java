...
import com.matthewmitchell.peercoinj.core.BloomFilter;
 ...
 * {@link com.matthewmitchell.peercoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link com.matthewmitchell.peercoinj.crypto.MnemonicCode},
 ...
 * {@link com.matthewmitchell.peercoinj.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link com.matthewmitchell.peercoinj.crypto.DeterministicKey#deserializeB58(com.matthewmitchell.peercoinj.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(com.matthewmitchell.peercoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link com.matthewmitchell.peercoinj.crypto.DeterministicHierarchy} and
 * {@link com.matthewmitchell.peercoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
     ...
     * The returned key can be serialized and then passed into {@link #watch(com.matthewmitchell.peercoinj.crypto.DeterministicKey)}
