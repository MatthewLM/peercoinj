...
public class DeterministicSeed implements EncryptableItem {
    ...
    /**
     * Constructs a seed from a BIP 39 mnemonic code. See {@link com.matthewmitchell.peercoinj.crypto.MnemonicCode} for more
     ...
     *
     * @throws com.matthewmitchell.peercoinj.crypto.MnemonicException if check fails
     */
