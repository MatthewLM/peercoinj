...
public interface EncryptableKeyChain extends KeyChain {
     ...
     * {@link #toEncrypted(com.matthewmitchell.peercoinj.crypto.KeyCrypter, org.spongycastle.crypto.params.KeyParameter)} with
     * {@link com.matthewmitchell.peercoinj.crypto.KeyCrypterScrypt} as the crypter.
     *
     ...
     * {@link com.matthewmitchell.peercoinj.core.Wallet.SendRequest#aesKey} field before asking the wallet to build the send.
     *
