...
/**
 * <p>A KeyChainGroup is used by the {@link com.matthewmitchell.peercoinj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws com.matthewmitchell.peercoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.matthewmitchell.peercoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws com.matthewmitchell.peercoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
