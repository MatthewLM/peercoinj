 ...
 * </ul>
 *
 * If initialized with a PeercoinURI or a url, a network request is made for the payment request object and a
...
public class PaymentSession {
     ...
     */
    public static ListenableFuture<PaymentSession> createFromPeercoinUri(final PeercoinURI uri) throws PaymentRequestException {
     ...
     */
    public static ListenableFuture<PaymentSession> createFromPeercoinUri(final PeercoinURI uri, final boolean verifyPki, @Nullable final String trustStorePath)
            throws PaymentRequestException {
        String url = uri.getPaymentRequestUrl();
        if (url == null)
            throw new PaymentRequestException.InvalidPaymentRequestURL("No payment request URL (r= parameter) in PeercoinURI " + uri);
        try {
