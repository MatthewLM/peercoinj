...
public final class MonetaryFormat {
    ...
    /**
     * Parse a human readable coin value to a {@link com.matthewmitchell.peercoinj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link com.matthewmitchell.peercoinj.core.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
