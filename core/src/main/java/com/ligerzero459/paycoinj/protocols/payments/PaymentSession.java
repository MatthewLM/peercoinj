...
public class PaymentSession {
 ...
 uri is a BIP-72-style PaycoinURI object that specifies where the {@link Protos.PaymentRequest} object may
     ...
     * be verified.</p>
     */
    public static ListenableFuture<PaymentSession> createFromPeercoinUri(final PaycoinURI uri) throws PaymentProtocolException {
     ...
     */
    public static ListenableFuture<PaymentSession> createFromPeercoinUri(final PaycoinURI uri, final boolean verifyPki)
     ...
     */
    public static ListenableFuture<PaymentSession> createFromPeercoinUri(final PaycoinURI uri, final boolean verifyPki, @Nullable final TrustStoreLoader trustStoreLoader)
            throws PaymentProtocolException {
