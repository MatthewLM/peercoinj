...
/**
 * <p>A KeyChainGroup is used by the {@link com.ligerzero459.paycoinj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws com.ligerzero459.paycoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link com.ligerzero459.paycoinj.crypto.KeyCrypterScrypt}.
     *
     * @throws com.ligerzero459.paycoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
