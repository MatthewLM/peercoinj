...
package com.ligerzero459.paycoinj.wallet;

import com.ligerzero459.paycoinj.crypto.EncryptedData;
...
import com.ligerzero459.paycoinj.crypto.DeterministicHierarchy;
import com.ligerzero459.paycoinj.crypto.HDKeyDerivation;
import com.ligerzero459.paycoinj.crypto.HDUtils;
 ...
 * {@link com.ligerzero459.paycoinj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link com.ligerzero459.paycoinj.crypto.MnemonicCode},
 ...
 * {@link com.ligerzero459.paycoinj.crypto.DeterministicKey#serializePubB58()}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link com.ligerzero459.paycoinj.crypto.DeterministicKey#deserializeB58(com.ligerzero459.paycoinj.crypto.DeterministicKey, String)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(com.ligerzero459.paycoinj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link com.ligerzero459.paycoinj.crypto.DeterministicHierarchy} and
 * {@link com.ligerzero459.paycoinj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from peercoinj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(com.ligerzero459.paycoinj.crypto.DeterministicKey)}
