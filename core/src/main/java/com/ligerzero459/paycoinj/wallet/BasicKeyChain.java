...
import com.ligerzero459.paycoinj.crypto.EncryptableItem;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws com.ligerzero459.paycoinj.store.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws com.ligerzero459.paycoinj.store.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
    ...
    /**
     * Convenience wrapper around {@link #toEncrypted(com.ligerzero459.paycoinj.crypto.KeyCrypter,
