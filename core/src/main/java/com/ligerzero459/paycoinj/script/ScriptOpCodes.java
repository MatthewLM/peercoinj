...
/**
 * Various constants that define the assembly-like scripting language that forms part of the Paycoin protocol.
 * See {@link com.ligerzero459.paycoinj.script.Script} for details. Also provides a method to convert them to a string.
 */
