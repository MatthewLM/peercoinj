 ...
 * the lightweight SPV mode, a {@link com.ligerzero459.paycoinj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link com.ligerzero459.paycoinj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
...
public abstract class AbstractBlockChain {
     ...
     *
     * Following this one down to the genesis block produces the story of the economy from the creation of Peercoin
