...
import com.ligerzero459.paycoinj.net.AbstractTimeoutHandler;
 ...
 * {@link com.ligerzero459.paycoinj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link com.ligerzero459.paycoinj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link com.ligerzero459.paycoinj.net.NioClientManager#openConnection(java.net.SocketAddress, com.ligerzero459.paycoinj.net.StreamParser)}
     * or
     * {@link com.ligerzero459.paycoinj.net.NioClient#NioClient(java.net.SocketAddress, com.ligerzero459.paycoinj.net.StreamParser, int)}.</p>
     *
     ...
     * Once the pong is received the value returned by {@link com.ligerzero459.paycoinj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link com.ligerzero459.paycoinj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link com.ligerzero459.paycoinj.core.Peer#ping()} has never
