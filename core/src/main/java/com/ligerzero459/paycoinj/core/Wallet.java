...
import com.ligerzero459.paycoinj.wallet.CoinSelector;
...
import com.ligerzero459.paycoinj.wallet.DefaultRiskAnalysis;
import com.ligerzero459.paycoinj.wallet.AllowUnconfirmedCoinSelector;
import com.ligerzero459.paycoinj.wallet.FilteringCoinSelector;
...
import com.ligerzero459.paycoinj.wallet.AllRandomKeysRotating;
import com.ligerzero459.paycoinj.wallet.KeyTimeCoinSelector;
import com.ligerzero459.paycoinj.wallet.DecryptingKeyBag;
import com.ligerzero459.paycoinj.wallet.KeyBag;
import com.ligerzero459.paycoinj.wallet.RedeemData;
import com.ligerzero459.paycoinj.wallet.DeterministicSeed;
import com.ligerzero459.paycoinj.wallet.CoinSelection;
...
import com.ligerzero459.paycoinj.protocols.payments.Protos.PaymentDetails;
import com.ligerzero459.paycoinj.core.TransactionConfidence.ConfidenceType;
...
import com.ligerzero459.paycoinj.script.ScriptChunk;
import com.ligerzero459.paycoinj.signers.LocalTransactionSigner;
import com.ligerzero459.paycoinj.signers.MissingSigResolutionSigner;
...
import com.ligerzero459.paycoinj.utils.BaseTaggableObject;
import com.ligerzero459.paycoinj.utils.ExchangeRate;
import com.ligerzero459.paycoinj.utils.ListenerRegistration;
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.ligerzero459.paycoinj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
     ...
     * {@link com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link com.ligerzero459.paycoinj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose)} with
     * {@link com.ligerzero459.paycoinj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of peercoinj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, com.ligerzero459.paycoinj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link com.ligerzero459.paycoinj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link com.ligerzero459.paycoinj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link com.ligerzero459.paycoinj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws com.ligerzero459.paycoinj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(com.ligerzero459.paycoinj.crypto.KeyCrypter,
     ...
     * {@link com.ligerzero459.paycoinj.crypto.KeyCrypterScrypt}.
     *
     ...
     * of {@link com.ligerzero459.paycoinj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link com.ligerzero459.paycoinj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link com.ligerzero459.paycoinj.signers.TransactionSigner.MissingSignatureException}
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link com.ligerzero459.paycoinj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link com.ligerzero459.paycoinj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
     ...
     */
    public void setTransactionBroadcaster(@Nullable com.ligerzero459.paycoinj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws com.ligerzero459.paycoinj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
     ...
     * {@link com.ligerzero459.paycoinj.core.PeerFilterProvider} interface and generally should not be used directly by apps.
