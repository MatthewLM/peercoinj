...
import com.ligerzero459.paycoinj.crypto.DRMWorkaround;
import com.ligerzero459.paycoinj.net.BlockingClientManager;
import com.ligerzero459.paycoinj.net.ClientConnectionManager;
import com.ligerzero459.paycoinj.net.FilterMerger;
import com.ligerzero459.paycoinj.net.NioClientManager;
import com.ligerzero459.paycoinj.net.discovery.PeerDiscovery;
import com.ligerzero459.paycoinj.net.discovery.PeerDiscoveryException;
import com.ligerzero459.paycoinj.net.discovery.TorDiscovery;
import com.ligerzero459.paycoinj.script.Script;
import com.ligerzero459.paycoinj.utils.ExponentialBackoff;
...
public class PeerGroup extends AbstractExecutionThreadService implements TransactionBroadcaster {
     ...
     *         Use {@link com.ligerzero459.paycoinj.core.Peer#getConnectionOpenFuture()} if you
     ...
     * peers. By using this with {@link com.ligerzero459.paycoinj.core.PeerGroup#getMaxConnections()} you can wait until the
     ...
     * {@link com.ligerzero459.paycoinj.core.PeerGroup#getMaxConnections()} returns is used.
     */
    ...
    /**
     * See {@link com.ligerzero459.paycoinj.core.PeerGroup#getMinBroadcastConnections()}.
     */
     ...
     * times are available via {@link com.ligerzero459.paycoinj.core.Peer#getLastPingTime()} but it increases load on the
     ...
     * using {@link com.ligerzero459.paycoinj.core.Peer#ping()}.
     */
