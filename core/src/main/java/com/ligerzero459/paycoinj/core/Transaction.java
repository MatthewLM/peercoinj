...
public class Transaction extends ChildMessage implements Serializable {
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, com.ligerzero459.paycoinj.script.Script, ECKey, com.ligerzero459.paycoinj.core.Transaction.SigHash, boolean)}
     ...
     * a wrapper around calling {@link Transaction#hashForSignature(int, byte[], com.ligerzero459.paycoinj.core.Transaction.SigHash, boolean)}
