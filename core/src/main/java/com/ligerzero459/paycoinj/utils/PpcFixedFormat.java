...
import static com.ligerzero459.paycoinj.core.Coin.SMALLEST_UNIT_EXPONENT;
 ...
 * custom pattern using either the {@link PpcFormat.Builder#localizedPattern} or {@link PpcFormat.Builder#localizedPattern()} methods, as described in the documentation for the {@link PpcFormat.Builder}
 * class.<ol>
 *
 * <p>A more detailed explanation, including examples, is in the documentation for the
 * {@link PpcFormat} class, and further information beyond that is in the documentation for the
...
public final class PpcFixedFormat extends PpcFormat {
     ...
     *  thet same value expressed in peercoins. */
    private final int scale;

    /** Constructor */
    protected PpcFixedFormat(
     ...
     * the denomination is millipeercoins, this method will return the value <code>3</code>.  As
     ...
     *  the denomination is millipeercoins, this method will return the value <code>3</code>.  */
    @Override
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof PpcFixedFormat)) return false;
        PpcFixedFormat other = (PpcFixedFormat)o;
