 ...
 * PpcFormat} class, and further information beyond that is in the documentation for the {@link
...
public final class PpcAutoFormat extends PpcFormat {
    ...
    /** Constructor */
    protected PpcAutoFormat(Locale locale, Style style, int fractionPlaces) {
    ...
    @Override public boolean equals(Object o) {
        ...
        if (!(o instanceof PpcAutoFormat)) return false;
        return super.equals((PpcAutoFormat)o);
    }
