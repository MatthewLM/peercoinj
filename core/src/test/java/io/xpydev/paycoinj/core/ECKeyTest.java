...
import io.xpydev.paycoinj.wallet.Protos.ScryptParameters;
import io.xpydev.paycoinj.core.Address;
import io.xpydev.paycoinj.core.Address;
import io.xpydev.paycoinj.core.DumpedPrivateKey;
import io.xpydev.paycoinj.core.DumpedPrivateKey;
import io.xpydev.paycoinj.core.ECKey;
import io.xpydev.paycoinj.core.ECKey;
...
import static io.xpydev.paycoinj.core.Utils.reverseBytes;
...
public class ECKeyTest {
    ...
    public void base58Encoding() throws Exception {
        String addr = "PKf1PvTHnNncWTigggeXPnt5GH6LuDsnM4";
        String privkey = "U7tnL54zz2JUJyPRvH9rWbHXNvVBeQhtBcVUQhYhcQvRa4bP5Kco";
    ...
    public void verifyMessage() throws Exception {
        // Test vector generated by Paycoin-Qt.
        String message = "hello";
        String sigBase64 = "HzXjY6CamtOrPBoOu1Sw62Lq2/w7bRb9IkNk0cgO6SxpsikxVqtuUkiHUo2v3VKDM/hdVtFGnca3/dKPONE1RRY=";
        Address expectedAddress = new Address(MainNetParams.get(), "PKf1PvTHnNncWTigggeXPnt5GH6LuDsnM4");
