...
import static com.matthewmitchell.peercoinj.testing.FakeTxBuilder.createFakeTx;
import static com.matthewmitchell.peercoinj.testing.FakeTxBuilder.makeSolvedTestBlock;
...
public class PaymentChannelStateTest extends TestWithWallet {
    ...
    public void setUp() throws Exception {
        ...
        chain = new BlockChain(params, wallet, blockStore, hashStore); // Recreate chain as sendMoneyToWallet will confuse it
    ...
    public void basic() throws Exception {
        ...
        Transaction refund = new Transaction(params, clientState.getIncompleteRefundTransaction().peercoinSerialize());
        ...
        Transaction multisigContract = new Transaction(params, clientState.getMultisigContract().peercoinSerialize());
        ...
        // Both client and server are now in the ready state. Simulate a few micropayments of 0.005 peercoins.
        Coin size = halfCoin.divide(100);
        Coin totalPayment = Coin.ZERO;
        for (int i = 0; i < 4; i++) {
            byte[] signature = clientState.incrementPaymentBy(size).signature.encodeToPeercoin();
        ...
        final Transaction reserializedCloseTx = new Transaction(params, closeTx.peercoinSerialize());
    ...
    public void setupDoS() throws Exception {
        ...
        serverState.incrementPayment(CENT.divide(2).subtract(CENT.divide(10)),
                clientState.incrementPaymentBy(CENT.divide(10)).signature.encodeToPeercoin());
    ...
    public void checkBadData() throws Exception {
        ...
        byte[] refundTxBytes = clientState.getIncompleteRefundTransaction().peercoinSerialize();
        ...
        byte[] multisigContractSerialized = clientState.getMultisigContract().peercoinSerialize();
        ...
        byte[] signature2 = clientState.incrementPaymentBy(halfCoin.subtract(totalPayment)).signature.encodeToPeercoin();
    ...
    public void feesTest() throws Exception {
        ...
        byte[] signature = clientState.incrementPaymentBy(Coin.SATOSHI).signature.encodeToPeercoin();
        ...
        serverState.incrementPayment(CENT.subtract(totalPayment), payment.signature.encodeToPeercoin());
    ...
    public void serverAddsFeeTest() throws Exception {
        ...
        signature = clientState.incrementPaymentBy(SATOSHI.multiply(2)).signature.encodeToPeercoin();
    ...
    public void doubleSpendContractTest() throws Exception {
        ...
        doubleSpendContract = new Transaction(params, doubleSpendContract.peercoinSerialize());
