...
import static com.matthewmitchell.peercoinj.protocols.channels.PaymentChannelCloseException.CloseReason;
import static com.matthewmitchell.peercoinj.testing.FakeTxBuilder.createFakeBlock;
import static com.matthewmitchell.peercoinj.paymentchannel.Protos.TwoWayChannelMessage.MessageType;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    public void setUp() throws Exception {
        ...
        serverChain = new BlockChain(params, serverWallet, blockStore, null);
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        com.matthewmitchell.peercoinj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
