...
import com.matthewmitchell.peercoinj.crypto.X509Utils;
import com.matthewmitchell.peercoinj.params.MainNetParams;
import com.matthewmitchell.peercoinj.params.UnitTestParams;
import com.matthewmitchell.peercoinj.protocols.payments.PaymentProtocol.Output;
import com.matthewmitchell.peercoinj.protocols.payments.PaymentProtocol.PkiVerificationData;
import com.matthewmitchell.peercoinj.protocols.payments.PaymentProtocolException.PkiVerificationException;
...
import com.matthewmitchell.peercoinj.protocols.payments.Protos.PaymentRequest;
...
public class PaymentProtocolTest {
    ...
    public void testPaymentRequest() throws Exception {
        // Create
        PaymentRequest paymentRequest = PaymentProtocol.createPaymentRequest(MainNetParams.get(), AMOUNT, TO_ADDRESS, MEMO,
