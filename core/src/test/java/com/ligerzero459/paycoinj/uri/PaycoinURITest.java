...
public class PaycoinURITest {
    ...
    public void testConvertToPeercoinURI() throws Exception {
        ...
        // simple example
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello&message=AMessage", PaycoinURI.convertToPeercoinURI(goodAddress, parseCoin("12.34"), "Hello", "AMessage"));
        
        // example with spaces, ampersand and plus
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello%20World&message=Mess%20%26%20age%20%2B%20hope", PaycoinURI.convertToPeercoinURI(goodAddress, parseCoin("12.34"), "Hello World", "Mess & age + hope"));

        // no amount, label present, message present
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?label=Hello&message=glory", PaycoinURI.convertToPeercoinURI(goodAddress, null, "Hello", "glory"));
        
        // amount present, no label, message present
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?amount=0.1&message=glory", PaycoinURI.convertToPeercoinURI(goodAddress, parseCoin("0.1"), null, "glory"));
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?amount=0.1&message=glory", PaycoinURI.convertToPeercoinURI(goodAddress, parseCoin("0.1"), "", "glory"));

        // amount present, label present, no message
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello", PaycoinURI.convertToPeercoinURI(goodAddress, parseCoin("12.34"), "Hello", null));
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?amount=12.34&label=Hello", PaycoinURI.convertToPeercoinURI(goodAddress, parseCoin("12.34"), "Hello", ""));
              
        // amount present, no label, no message
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?amount=1000", PaycoinURI.convertToPeercoinURI(goodAddress, parseCoin("1000"), null, null));
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?amount=1000", PaycoinURI.convertToPeercoinURI(goodAddress, parseCoin("1000"), "", ""));
        
        // no amount, label present, no message
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?label=Hello", PaycoinURI.convertToPeercoinURI(goodAddress, null, "Hello", null));
        
        // no amount, no label, message present
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?message=Agatha", PaycoinURI.convertToPeercoinURI(goodAddress, null, null, "Agatha"));
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS + "?message=Agatha", PaycoinURI.convertToPeercoinURI(goodAddress, null, "", "Agatha"));
      
        // no amount, no label, no message
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS, PaycoinURI.convertToPeercoinURI(goodAddress, null, null, null));
        assertEquals("ppcoin:" + MAINNET_GOOD_ADDRESS, PaycoinURI.convertToPeercoinURI(goodAddress, null, "", ""));
    }
