...
import com.ligerzero459.paycoinj.wallet.RiskAnalysis;
import com.ligerzero459.paycoinj.wallet.DeterministicKeyChain;
import com.ligerzero459.paycoinj.wallet.WalletFiles;
import com.ligerzero459.paycoinj.wallet.KeyChain;
import com.ligerzero459.paycoinj.wallet.DeterministicUpgradeRequiresPassword;
import com.ligerzero459.paycoinj.wallet.KeyTimeCoinSelector;
import com.ligerzero459.paycoinj.wallet.KeyChainGroup;
import com.ligerzero459.paycoinj.wallet.KeyBag;
import com.ligerzero459.paycoinj.wallet.WalletTransaction;
import com.ligerzero459.paycoinj.wallet.AllowUnconfirmedCoinSelector;
import com.ligerzero459.paycoinj.wallet.DefaultCoinSelector;
import com.ligerzero459.paycoinj.wallet.Protos;
import com.ligerzero459.paycoinj.testing.KeyChainTransactionSigner;
import com.ligerzero459.paycoinj.testing.TestWithWallet;
import com.ligerzero459.paycoinj.testing.NopTransactionSigner;
import com.ligerzero459.paycoinj.testing.MockTransactionBroadcaster;
import com.ligerzero459.paycoinj.testing.FakeTxBuilder;
import com.ligerzero459.paycoinj.crypto.KeyCrypterException;
import com.ligerzero459.paycoinj.crypto.KeyCrypterScrypt;
import com.ligerzero459.paycoinj.crypto.MnemonicException;
import com.ligerzero459.paycoinj.crypto.ChildNumber;
import com.ligerzero459.paycoinj.crypto.DeterministicKey;
import com.ligerzero459.paycoinj.crypto.KeyCrypter;
import com.ligerzero459.paycoinj.crypto.TransactionSignature;
import com.ligerzero459.paycoinj.core.Wallet.SendRequest;
import com.ligerzero459.paycoinj.params.MainNetParams;
import com.ligerzero459.paycoinj.script.Script;
import com.ligerzero459.paycoinj.script.ScriptBuilder;
import com.ligerzero459.paycoinj.script.ScriptOpCodes;
import com.ligerzero459.paycoinj.signers.StatelessTransactionSigner;
import com.ligerzero459.paycoinj.signers.TransactionSigner;
import com.ligerzero459.paycoinj.store.BlockStoreException;
import com.ligerzero459.paycoinj.store.MemoryBlockStore;
import com.ligerzero459.paycoinj.store.UnreadableWalletException;
import com.ligerzero459.paycoinj.store.WalletProtobufSerializer;
import com.ligerzero459.paycoinj.utils.ExchangeRate;
import com.ligerzero459.paycoinj.utils.Fiat;
import com.ligerzero459.paycoinj.utils.Threading;
import com.ligerzero459.paycoinj.wallet.WalletTransaction.Pool;
import com.google.common.collect.ImmutableList;
import com.google.common.collect.Lists;
import com.google.common.util.concurrent.ListenableFuture;
import com.google.protobuf.ByteString;
import com.ligerzero459.paycoinj.wallet.Protos.Wallet.EncryptionType;
import com.ligerzero459.paycoinj.core.AbstractBlockChain;
import com.ligerzero459.paycoinj.core.AbstractWalletEventListener;
import com.ligerzero459.paycoinj.core.Address;
import com.ligerzero459.paycoinj.core.Block;
import com.ligerzero459.paycoinj.core.BlockChain;
import com.ligerzero459.paycoinj.core.Coin;
import com.ligerzero459.paycoinj.core.ECKey;
import com.ligerzero459.paycoinj.core.InsufficientMoneyException;
import com.ligerzero459.paycoinj.core.PeerAddress;
import com.ligerzero459.paycoinj.core.Sha256Hash;
import com.ligerzero459.paycoinj.core.StoredBlock;
import com.ligerzero459.paycoinj.core.Transaction;
import com.ligerzero459.paycoinj.core.TransactionConfidence;
...
import static com.ligerzero459.paycoinj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    private void basicSpendingCommon(Wallet wallet, Address toAddress, Address destination, boolean testEncryption) throws Exception {
        ...
        // will attach a small fee. Because the Peercoin protocol makes it difficult to determine the fee of an
