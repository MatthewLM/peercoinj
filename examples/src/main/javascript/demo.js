// This file shows how to use peercoinj from Javascript.
// To run, grab the peercoinj bundled JAR and then do something like this:
//
//   jjs -cp peercoinj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp peercoinj-0.12-bundled.jar
//
...
//
//   jjs -cp peercoinj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And peercoinj is a threaded library. This means you
