...
import io.xpydev.paycoinj.kits.WalletAppKit;
 ...
 * The WalletAppKit class wraps the boilerplate (Peers, BlockChain, BlockStorage, Wallet) needed to set up a new SPV peercoinj app.
 * 
...
public class Kit {
    ...
    public static void main(String[] args) {
        ...
        // - MainNetParams
        // - RegTestParams
        // While developing your application you probably want to use the Regtest mode and run your local peercoin network. Run peercoind with the -regtest flag
        ...
        // In case you want to connect with your local peercoind tell the kit to connect to localhost.
        // You must do that in reg test mode.
        //kit.connectToLocalHost();

        // Now we start the kit and sync the blockchain.
        // peercoinj is working a lot with the Google Guava libraries. The WalletAppKit extends the AbstractIdleService. Have a look at the introduction to Guava services: https://code.google.com/p/guava-libraries/wiki/ServiceExplained
        kit.startAsync();
        kit.awaitRunning();

        // To observe wallet events (like coins received) we implement a EventListener class that extends the AbstractWalletEventListener peercoinj then calls the different functions from the EventListener class
